...
class __TwigTemplate_898a32edf9e073c4b3fcc92ac84c7a3a4419a3fd0d62aa09d017dd1b405af45b extends \Twig\Template
{
...
($context["installing"] ?? null)) {
                ...
                if (($this->getAttribute($context["plugin"], "premium", []) &&  !$this->getAttribute(($context["admin"] ?? null), "license", [0 => $this->getAttribute($context["plugin"], "slug", [])], "method"))) {
                    ...
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($context["plugin"], "premium", []), "product_permalink", []), "html", null, true);
...
", "partials/plugins-list.html.twig", "/Applications/MAMP/htdocs/portfolio-grav/user/plugins/admin/themes/grav/templates/partials/plugins-list.html.twig");
    }
}
