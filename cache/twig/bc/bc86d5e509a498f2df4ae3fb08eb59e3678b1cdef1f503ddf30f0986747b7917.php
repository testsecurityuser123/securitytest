...
class __TwigTemplate_b3cb4d213b7c9e24414fc5f32bef8dfaf8c424dcb0b829ca16a59dbfb67094a1 extends \Twig\Template
{
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["latest"]) {
                ...
                <td class=\"triple page-route\">";
                    ...
                    echo "</td><td>";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->adminNicetimeFilter($this->getAttribute($context["latest"], "modified", [])), "html", null, true);
                    echo "</td>
            </tr>
        ";
                }
...
{% endif %}
", "partials/dashboard-pages.html.twig", "/Applications/MAMP/htdocs/portfolio-grav/user/plugins/admin/themes/grav/templates/partials/dashboard-pages.html.twig");
    }
}
